...
import 'package:mijnzpc/pages/checkforgetpasswordcode.dart';
...
class Forgetpassword extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => new ForgetpasswordState();

}

class ForgetpasswordState extends State<Forgetpassword> with SingleTickerProviderStateMixin {
                            ...
                            children: <Widget>[
                              Padding(
                                ...
                                child: Align(
                                  ...
                                  child:
                                  Text(allTranslations.text("Forget Password"),style: TextStyle(
                              ...
                              Padding(
                                ...
                                child: Align(
                                  alignment: Alignment.centerLeft,
                                  child:
                                  Text(allTranslations.text("Please enter your email adress"),style: TextStyle(
                                      // fontWeight: FontWeight.w700,
                                      letterSpacing: 0.5,
                                      color: Colors.white,
                                      fontSize: 14
                                          ...
                                          Padding(
                                            ...
                                            child: TextFormField(
                                              ...
                                              decoration: InputDecoration(
                                                hintText: allTranslations.text("Enter Your email"),
                                              ...
                                              child:  DecoratedBox(
                                                  ...
                                                  child:ElevatedButton(
                                                      ...
                                                      onPressed: ()async{
                                                                  ...
                                                                  builder: (context) {
                                                                    return new Directionality(
                                                                        ...
                                                                        child: new AlertDialog(
                                                                          ...
                                                                          content: new Text(allTranslations.text("please insert your email")),
                                                                          actions: <Widget>[
                                                        ...
                                                        final response = await  http.get(Uri.parse('https://mijnzpc.com/api/v1/forgetpassword?email=' + _emailValue));
                                                        var responseBody = json.decode(response.body);
                                                      //  print(responseBody['data']);

                                                  Navigator.push(context, new MaterialPageRoute(builder: (context) => new Checkforgetpasswordcode(email:_emailValue)));
                                                      ...
                                                      child: Padding(
                                                        ...
                                                        child:Center(
                                                          child: Text(allTranslations.text('Send') ,textAlign: TextAlign.center,style: TextStyle(fontSize: 18)),
                                                        ),
                                                      )
                                                  )
                                              )
