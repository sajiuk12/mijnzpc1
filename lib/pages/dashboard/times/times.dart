...
class _AssignmentState extends State<Times> {
                             ...
                             children: <Widget>[
                                   ...
                                   children: <Widget>[
                                     ...
                                     ListTile(
                                       ...
                                       trailing:Text(allTranslations.text(changestatus(gettoz(_recordsdata[index].status))),style: TextStyle(
                                         color: Colors.grey,
                                         // fontWeight: FontWeight.w700,
                                         fontSize: 12.0,
                                       ),),
...
//if user pull to refresh page
  ...
  _getrecords({ int page : 1 , bool refresh : false}) async
  {
    ...
    var response = await classgetservicestimes.actiongettimes(page,sortname,jobtitlename,clientid,departmentid,employeeid,statusname,yearname,monthname,startdatename);
    setState(() {
