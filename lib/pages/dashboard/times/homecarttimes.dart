...
class HomecartTimes extends StatefulWidget {
  ...
  @override
  HomecartTimesState createState() => HomecartTimesState();
}

class HomecartTimesState extends State<HomecartTimes> {
      ...
      Scaffold(
        appBar: new AppBar(
          ...
          title:Padding(
            ...
            child: new Text(allTranslations.text('send times'),style: TextStyle(color: Colors.grey),),),
                                  ...
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      ListTile(
                                        ...
                                        trailing: Text(
                                          allTranslations.text( changestatus(_recordsdata[index].status.toString())) ,
                                          style: TextStyle(
                                            color: Colors.grey,
                                            // fontWeight: FontWeight.w700,
                                            fontSize: 12.0,
...
//if user pull to refresh page
  ...
  _getrecords({ int page : 1 , bool refresh : false}) async
  {
    ...
    var response = await classgetservicestimes.actionhomecarttimes(page);
    setState(() {
