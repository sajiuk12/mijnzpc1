...
class HomecartOpenassignment extends StatefulWidget {

  HomecartOpenassignment(
...
class _OpenassignmentState extends State<HomecartOpenassignment> {
                                ...
                                new GestureDetector(
                                  onTap: () {
                                    Navigator.push(context,
                                        new MaterialPageRoute(builder: (context) => new Detopenassignment(data: _recordsdata[index],
                                          backgroundcolor: widget.backgroundcolor,
                                          color: widget.color,
                                    ...
                                    children: <Widget>[
                                      Align(
                                        ...
                                        child: Padding(
                                          ...
                                          child: FutureBuilder<String>(
                                            future: getdepartmentname(_recordsdata[index].department_id.toString()),
                                      ...
                                      Align(
                                        ...
                                        child: Padding(
                                          padding: const EdgeInsets.fromLTRB(10, 5, 0, 0),
                                          child:  FutureBuilder<String>(
                                            future: getclientname(_recordsdata[index].client_id.toString()),
                                            builder: (context, snapshot) {
                                              if (snapshot.hasData) return Text(snapshot.data, style: TextStyle(
                                                color: Colors.grey,
                                                // fontWeight: FontWeight.w700,
                                          ...
                                          child: Wrap(
                                            ...
                                            children: [
                                              ...
                                              Padding(
                                                ...
                                                child: Text(  converttotime(_recordsdata[index].time_from)+"-"+converttotime(_recordsdata[index].time_to),
                                                  style: TextStyle(
                                                    color: Colors.grey,
                                                    // fontWeight: FontWeight.w700,
                                                    fontSize: 14.0,
                                      ...
                                      ListTile(
                                        ...
                                        trailing: Text(
                                          allTranslations.text(_recordsdata[index].status.toString()) ,
                                          style: TextStyle(
                                            color: Colors.grey,
                                            // fontWeight: FontWeight.w700,
                                            fontSize: 12.0,
...
//if user pull to refresh page
  ...
  _getrecords({ int page : 1 , bool refresh : false}) async
  {
    ...
    var response = await classgetservicesassignment.actiongetopenassignment(page,sortname,jobtitlename,clientid,departmentid,employeeid,statusname,yearname,monthname,startdatename,"","");
    setState(() {
