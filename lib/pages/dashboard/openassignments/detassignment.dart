...
class Detopenassignment extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => new DetopenassignmentState();

}

class DetopenassignmentState extends State<Detopenassignment> with AutomaticKeepAliveClientMixin<Detopenassignment> {
...
String department_id="";
    ...
    return Scaffold(
      appBar: new AppBar(
        ...
        title:Padding(
          ...
          child: new Text(allTranslations.text('Open assignment detail:')+widget.data.id.toString(),style: TextStyle(color: Colors.grey),),),
                    ...
                    child: acceptvisibility ? DecoratedBox(
                        ...
                        child:ElevatedButton(
                                    ...
                                    return new Container(
                                        ...
                                        child: new Directionality(
                                            ...
                                            child: new AlertDialog(
                                              ...
                                              content: new Text(allTranslations.text('By applying for this assignment, you are also accepting the terms of the agreement. Proceed?'),style: TextStyle(color: Colors.grey)),
                                              actions: <Widget>[
                                                new FlatButton(
                                                ...
                                                new FlatButton(
                                                    onPressed: () async{
                                                      ...
                                                      String url ='https://mijnzpc.com/api/v1/sendsuggestion?token='+token+'&id='+widget.data.id.toString();
                                                      print(url);
                            ...
                            child: Padding(
                              ...
                              child:Center(
                                child: Text(allTranslations.text('Send suggestion') ,textAlign: TextAlign.center,style: TextStyle(fontSize: 18)),
                              ),
                            )
                        )
                    ): new Container()
      ...
      SingleChildScrollView(
        child:      Column(
          children: <Widget>[
                      ...
                      child:  SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: ()async{
                              ...
                              SharedPreferences prefs = await SharedPreferences.getInstance();
                              String token = prefs.getString('user.api_token');
                              final payUrl = 'https://mijnzpc.com/api/v1/exportpreAgreementPDF?token='+token+'&assignment_id='+widget.data.id.toString();
                              print(payUrl);
                              ...
                              children: <Widget>[
                                SizedBox(
                                  ...
                                  Align(
                                    alignment: Alignment.centerLeft,
                                    child:  new Text(
                                        "Є "+widget.data.client_payrate.toString(),
                                      textAlign: TextAlign.left,
                                      style:   TextStyle(
                                       // fontWeight: FontWeight.w500,
                                        fontSize: 17.0,
                              ...
                              children: <Widget>[
                                SizedBox(
                                  ...
                                  Align(
                                    alignment: Alignment.centerLeft,
                                    child:  new Text(
                                      "Є " +allTranslations.text("totalclientpayrate"),
                                      textAlign: TextAlign.left,
                                      style:   TextStyle(
                                        //fontWeight: FontWeight.w500,
                                        fontSize: 17.0,
            ...
            Padding(
              padding: EdgeInsets.only(top:5,left: 0,right: 0,bottom: 140),
              child:     Container(
                width: MediaQuery.of(context).size.width,
                // height: 140.0,
                decoration: BoxDecoration(
  ...
  getdet() async{
    ...
    String token = prefs.getString('user.api_token');
    String type = prefs.getString('user.type');
    int user_id = prefs.getInt('user.id');

    String url ='https://mijnzpc.com/api/v1/detopenassignment?token='+token+'&id='+widget.data.id.toString();
    print(url);
    final response = await http.get(Uri.parse(url),);
    if(response.statusCode == 200) {
      ...
      // {
        //print(responseBody['assignment'][0]['employee_id1']);
        setState(() {

          department_id=responseBody['assignment'][0]['department_id'].toString();

          startdatee=responseBody['startdate'].toString();

          totalpayrate=responseBody['totalpayrate'].toString();
          totalclientpayrate=responseBody['totalclientpayrate'].toString();
         // start_date=gettoz(responseBody['assignment'][0]['start_date'].toString());
          duration=responseBody['durationintime'].toString();
          calculatednumber=responseBody['calculatednumberhours'].toString();
          ...
          to=responseBody['to'];
          defualtsurcharge=responseBody['defualtsurcharge'].toString();
          ...
          temppayrate=responseBody['payrate'];




          if(responseBody['department_address'][0]['description']!=null){
            department_description=responseBody['department_address'][0]['description'].toString();
          }

          if(responseBody['department_address'][0]['requirements']!=null){
            department_requirment=responseBody['department_address'][0]['requirements'].toString();
          }

         if(responseBody['department_address'][0]['conditions']!=null){
           department_Conditions=responseBody['department_address'][0]['conditions'].toString();
         }


          if(responseBody['department_address'][0]['cost']!=null){
            department_Cost=responseBody['department_address'][0]['cost'].toString();
          }


          if(responseBody['department_address'][0]['phone']!=null){
            department_Phone=responseBody['department_address'][0]['phone'].toString();
          }
      ...
      String url2 ='https://mijnzpc.com/api/v1/departmentinfo?token='+token+'&id='+department_id.toString();
      ...
      if(response2.statusCode == 200) {
        ...
        if(responseBody2['department'].toList().length > 0)
        {
          setState(() {


            if(responseBody2['department'][0]['description']!=null){
              department_description=responseBody2['department'][0]['description'].toString();
            }

            if(responseBody2['department'][0]['requirements']!=null){
              department_requirment=responseBody2['department'][0]['requirements'].toString();
            }

            if(responseBody2['department'][0]['conditions']!=null){
              department_Conditions=responseBody2['department'][0]['conditions'].toString();
            }

            if(responseBody2['department'][0]['cost']!=null){
              department_Cost=responseBody2['department'][0]['cost'].toString();
            }


            if(responseBody2['department'][0]['phone']!=null){
              department_Phone=responseBody2['department'][0]['phone'].toString();
            }
  ...
  _launchPhoneURL() async {
    ...
    if(response2.statusCode == 200) {
      ...
      if(responseBody2['department'].toList().length > 0)
      {
        tell = responseBody2['department'][0]['phone'].toString();
      }
