...
class Managedocument extends StatefulWidget {
...
class _ManagedocumentState extends State<Managedocument> {
                        ...
                        Container(
                          ...
                          Padding(
                            ...
                            child: Align(
                              ...
                              child: InkWell(
                                onTap: () {
                                  Navigator.push(context, new MaterialPageRoute(builder: (context) => new Managedocumentoptional(backgroundcolor: widget.backgroundcolor,
                                    color: widget.color,
                                    gradiantcolor:widget.gradiantcolor,
                                    cardcolor:widget.cardcolor,
                                    shadowcolor:widget.shadowcolor,
