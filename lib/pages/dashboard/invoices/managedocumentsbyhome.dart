...
import 'package:mijnzpc/pages/dashboard/invoices/managedocumentoptionalbyhome.dart';
...
class Managedocumentbyhome extends StatefulWidget {

  Managedocumentbyhome(
  ...
  @override
  _ManagedocumentbyhomeState createState() => _ManagedocumentbyhomeState();
}

class _ManagedocumentbyhomeState extends State<Managedocumentbyhome> {
                        ...
                        Container(
                          ...
                          Padding(
                            ...
                            child: Align(
                              ...
                              child: InkWell(
                                onTap: () {
                                  Navigator.push(context, new MaterialPageRoute(builder: (context) => new Managedocumentoptionalbyhome(backgroundcolor: widget.backgroundcolor,
                                    color: widget.color,
                                    gradiantcolor:widget.gradiantcolor,
                                    cardcolor:widget.cardcolor,
                                    shadowcolor:widget.shadowcolor,
