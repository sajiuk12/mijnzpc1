...
import 'package:mijnzpc/pages/filters/filterinvoicetype.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:mijnzpc/pages/dashboard/invoices/detinvoice.dart';
                          ...
                          child:  DecoratedBox(
                              ...
                              child:ElevatedButton(
                                  ...
                                  child: Padding(
                                    ...
                                    child:Center(
                                      child: Text(allTranslations.text('Job Title : ')+allTranslations.text(yearname)),
                                    ),
                                  )
                              )
                          )
                          ...
                          child:  DecoratedBox(
                              ...
                              child:ElevatedButton(
                                  ...
                                  child: Padding(
                                    ...
                                    child:Center(
                                      child: Text(allTranslations.text('Type : ')+allTranslations.text(typename)),
                                    ),
                                  )
                              )
                          )
                      ...
                      itemBuilder: (BuildContext context , int index)
                      {
                        ...
                        return GestureDetector(
                          ...
                          Navigator.push(context,
                              new MaterialPageRoute(builder: (context) => new Detinvoice(data: _recordsdata[index],
                                backgroundcolor: widget.backgroundcolor,
                                color: widget.color,
                                  ...
                                  Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      ListTile(
                                        ...
                                        trailing: Text(
                                          invoicenumber(_recordsdata[index].id,_recordsdata[index].invoicenumber) ,
                                          style: TextStyle(
                                            color: Colors.grey,
                                            // fontWeight: FontWeight.w700,
                                            fontSize: 12.0,
                                      ...
                                      ListTile(
                                        ...
                                        trailing:Text("€ "+gettoz(_recordsdata[index].totalinvoice),style: TextStyle(
                                          color: widget.color,
                                          fontWeight: FontWeight.w700,
                                          fontSize: 20.0,
...
//if user pull to refresh page
  ...
  _getrecords({ int page : 1 , bool refresh : false}) async
  {
    ...
    var response = await classgetservicesinvoice.actiongetinvoices(page,sortname,jobtitlename,clientid,departmentid,employeeid,statusname,yearname,monthname,startdatename,typename);
    setState(() {
...
//if user pull to refresh page
  ...
  void _getfiltertype(BuildContext context) async {
    final result = await  Navigator.of(context).push(
        MaterialPageRoute(builder:(context)=>Filterinvoicetype(
          idfromfirstpage:jobtitleid.toString(),
          backgroundcolor: widget.backgroundcolor,
          color: widget.color,
          gradiantcolor:widget.gradiantcolor,
          cardcolor:widget.cardcolor,
  ...
  invoicenumber(int id,String invoicenumber)
  {
