...
class FullAssignment extends StatefulWidget {
...
class _AssignmentState extends State<FullAssignment> {
      ...
      Scaffold(
        appBar: new AppBar(
          ...
          title:Padding(
            ...
            child: new Text(allTranslations.text('Assignment'),style: TextStyle(color: Colors.grey),),),
                                    ...
                                    children: <Widget>[
                                      Align(
                                        ...
                                        child: Padding(
                                          ...
                                          child:FutureBuilder<String>(
                                            future: getdepartmentname(_recordsdata[index].id.toString()),
                                            builder: (context, snapshot) {
                                              ...
                                              return Text(allTranslations.text("Await for data"));
                                            },
                                          ),
                                        ),
                                      ),
                                      Align(
                                        ...
                                        child: Padding(
                                          padding: const EdgeInsets.fromLTRB(10, 5, 0, 0),
                                          child: FutureBuilder<String>(
                                            future: getclientname(_recordsdata[index].id.toString()),
                                            builder: (context, snapshot) {
                                              if (snapshot.hasData) return Text(allTranslations.text(snapshot.data), style: TextStyle(
                                                color: Colors.grey,
                                                // fontWeight: FontWeight.w700,
                                          ...
                                          child:  Wrap(
                                            ...
                                            children: [
                                              ...
                                              Padding(
                                                  ...
                                                  child: Text(allTranslations.text( _recordsdata[index].start_date.toString()),
                                                    style: TextStyle(
                                                      color: Colors.grey,
                                                      // fontWeight: FontWeight.w700,
                                                      fontSize: 14.0,
                                          ...
                                          child: Wrap(
                                            ...
                                            children: [
                                              ...
                                              Padding(
                                                ...
                                                child:FutureBuilder<String>(
                                                  future: getfrom(_recordsdata[index].id.toString()),
                                                  builder: (context, snapshot) {
                                                    if (snapshot.hasData) return Text(allTranslations.text(snapshot.data),style: TextStyle(
                                                      color: Colors.grey,
                                                      // fontWeight: FontWeight.w700,
                                          ...
                                          child: Padding(
                                            ...
                                            child:   Wrap(
                                              ...
                                              children: [
                                                ...
                                                checkemployee ? Icon(Icons.euro_rounded,color: widget.color,): new Container(),
                                                checkemployee ?  Padding(
                                                  padding: const EdgeInsets.fromLTRB(20, 0, 5, 0),
                                                  child:FutureBuilder<String>(
                                                    future: gettotalearnings(_recordsdata[index].id.toString()),
                                                    builder: (context, snapshot) {
                                                      if (snapshot.hasData) return Text(allTranslations.text(snapshot.data),style: TextStyle(
                                                        color: Colors.grey,
                                                        // fontWeight: FontWeight.w700,
                                                ...
                                                checkadmin ? Padding(
                                                  padding: const EdgeInsets.fromLTRB(20, 0, 5, 0),
                                                  child:FutureBuilder<String>(
                                                    future: getemployeename(_recordsdata[index].id.toString()),
                                                    builder: (context, snapshot) {
                                                      if (snapshot.hasData) return Text(allTranslations.text(snapshot.data),style: TextStyle(
                                                        color: Colors.grey,
                                                        // fontWeight: FontWeight.w700,
...
//  getting data from model
  ...
  Widget listIsEmpty() {
    return new Center(
      child: new Text(allTranslations.text(searchmsg)),
    );
  }
  //if user pull to refresh page
