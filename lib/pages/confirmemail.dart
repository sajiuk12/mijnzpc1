...
class Confirmemail extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => new ConfirmemailState();

}

class ConfirmemailState extends State<Confirmemail> with SingleTickerProviderStateMixin {
                                              ...
                                              child:  DecoratedBox(
                                                  ...
                                                  child:ElevatedButton(
                                                      ...
                                                      onPressed: ()async{
                                                              ...
                                                              builder: (context) {
                                                                return new Directionality(
                                                                    ...
                                                                    child: new AlertDialog(
                                                                      ...
                                                                      content: new Text(allTranslations.text("please insert your code")),
                                                                      actions: <Widget>[
                                                        ...
                                                        final response = await  http.get(Uri.parse('https://mijnzpc.com/api/v1/Checkemailcode?token=' + token+'&code='+_emailValue));
...
print('ddddddd');
    SharedPreferences prefs = await SharedPreferences.getInstance();
    String token = prefs.getString('user.api_token');
    String url ='https://mijnzpc.com/api/v1/resendconfirmemailcode?token='+token;
    print(url);
