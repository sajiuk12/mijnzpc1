...
class ProfileState extends State<Profile> with AutomaticKeepAliveClientMixin<Profile> {
                ...
                child:  SizedBox(
                    ...
                    child:  DecoratedBox(
                        ...
                        child:ElevatedButton(
                            ...
                            onPressed: (){
                              Navigator.push(context, new MaterialPageRoute(builder: (context) => new Managedocument(backgroundcolor: widget.backgroundcolor,
                                color: widget.color,
                                gradiantcolor:widget.gradiantcolor,
                                cardcolor:widget.cardcolor,
                                shadowcolor:widget.shadowcolor,
                              ...
                              Theme(
                                ...
                                child: ExpansionTile(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Padding(
                                      ...
                                      Row(
                                        children: <Widget>[
                                          ...
                                          Expanded(
                                            flex: 5,
                                            child:  Text(eurodate(birthdate),style: TextStyle(color: Colors.grey,
                                              fontSize: 15.0,)),
                                          ),
                                    ...
                                    Padding(
                                      padding: EdgeInsets.only(top:5,left: 15,right: 0,bottom: 10),
                                      child:
                                      Row(
                                        children: <Widget>[
                                    ...
                                    Padding(
                                      ...
                                      Row(
                                        children: <Widget>[
                                          ...
                                          Expanded(
                                            flex: 5,
                                            child:  Text(tell,style: TextStyle(color: Colors.grey,
                                              fontSize: 15.0,)),
                                          ),
                                    ...
                                    Padding(
                                      ...
                                      Row(
                                        children: <Widget>[
                                          ...
                                          Expanded(
                                            flex: 3,
                                            child: Text(allTranslations.text('Extra Adress : '),style: TextStyle(color: Colors.grey[600],fontSize: 15.0,)),
                                          ),

                                          Expanded(
                                            flex: 5,
                                            child:  Text(addressextra,style: TextStyle(color: Colors.grey,
                                              fontSize: 15.0,)),
                                          ),
