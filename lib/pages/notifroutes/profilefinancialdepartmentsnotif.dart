...
class Profilefinancialpartmentnotif extends StatefulWidget {

  Profilefinancialpartmentnotif(
  ...
  @override
  State<StatefulWidget> createState() => new ProfilefinancialpartmentnotifState();

}

class ProfilefinancialpartmentnotifState extends State<Profilefinancialpartmentnotif> with AutomaticKeepAliveClientMixin<Profilefinancialpartmentnotif> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
        onWillPop: () async {
      Navigator.push(context, new MaterialPageRoute(builder: (context) => new Financialdepartments(
    ...
    if(response.statusCode == 200) {
      ...
      if(responseBody['profile'].toList().length > 0)
      {
        ...
        setState(() {
          ...
          print(responseBody['clientinfo'][0]['company_name']);
