...
class Profileclientnotif extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => new ProfileclientnotifState();

}

class ProfileclientnotifState extends State<Profileclientnotif> with AutomaticKeepAliveClientMixin<Profileclientnotif> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
        onWillPop: () async {
      Navigator.push(context, new MaterialPageRoute(builder: (context) => new Clients(
      ...
      if(responseBody['profile'].toList().length > 0)
      {
        ...
        setState(() {
          ...
          if(responseBody['Address'].toList().length > 0){
            ...
            if(responseBody['Address'][0]['country']!=null){
              country = responseBody['Address'][0]['country'];
            }



            if(responseBody['Address'][0]['address']!=null){
            ...
            if(responseBody['Address'][0]['city']!=null){
