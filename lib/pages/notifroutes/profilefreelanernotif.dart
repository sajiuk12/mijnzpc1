...
class Profilefreelancernotif extends StatefulWidget {

  Profilefreelancernotif(
  ...
  @override
  State<StatefulWidget> createState() => new ProfilefreelancernotifState();

}

class ProfilefreelancernotifState extends State<Profilefreelancernotif> with AutomaticKeepAliveClientMixin<Profilefreelancernotif> {
