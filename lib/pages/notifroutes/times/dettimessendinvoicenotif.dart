...
class Dettimes2notif extends StatefulWidget {
  ...
  @override
  _Dettimes2notif createState() => _Dettimes2notif();
}

class _Dettimes2notif extends State<Dettimes2notif> {
                  ...
                  child:  SizedBox(
                    ...
                    child:  sendinvoice ?DecoratedBox(
                        ...
                        child:ElevatedButton(
                            ...
                            onPressed: (){
                              Navigator.push(context, new MaterialPageRoute(builder: (context) => new Sendinvoice(
                                  timesid:widget.data.id,
                                backgroundcolor: widget.backgroundcolor,
                                color: widget.color,
                                gradiantcolor:widget.gradiantcolor,
                                cardcolor:widget.cardcolor,
