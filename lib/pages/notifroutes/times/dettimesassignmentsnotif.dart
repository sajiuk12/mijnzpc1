...
class Dettimesassignmentnotif extends StatefulWidget {

  Dettimesassignmentnotif(
  ...
  @override
  State<StatefulWidget> createState() => new DettimesassignmentnotifState();

}

class DettimesassignmentnotifState extends State<Dettimesassignmentnotif> with AutomaticKeepAliveClientMixin<Dettimesassignmentnotif> {
...
String extra_description="-";
                ...
                child:  SizedBox(
                    ...
                    child:   adminvisibility ? DecoratedBox(
                        ...
                        child:ElevatedButton(
                            ...
                            onPressed: () async {
                              Navigator.push(context, new MaterialPageRoute(builder: (context) => new Addrejectcomment(assignmentid:widget.data.assignments_id,
                                backgroundcolor: widget.backgroundcolor,
                                color: widget.color,
                                gradiantcolor:widget.gradiantcolor,
                                cardcolor:widget.cardcolor,
                      ...
                      child:  SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: ()async{
                              ...
                              final payUrl = 'https://mijnzpc.com/api/v1/exportAgreementPDF?token='+token+'&assignment_id='+widget.data.assignments_id.toString();
                              print(payUrl);
  ...
  getdet() async{
    ...
    String url ='https://mijnzpc.com/api/v1/detassignment?token='+token+'&id='+widget.data.assignments_id.toString();
    print(url);
