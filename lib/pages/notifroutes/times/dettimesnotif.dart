...
class Dettimesnotif extends StatefulWidget {
  ...
  @override
  _Dettimesnotif createState() => _Dettimesnotif();
}

class _Dettimesnotif extends State<Dettimesnotif> {
                    ...
                    child: sendtimes ? DecoratedBox(
                        ...
                        child:ElevatedButton(
                                    ...
                                    return new Container(
                                        ...
                                        child: new Directionality(
                                            ...
                                            child: new AlertDialog(
                                              ...
                                              title: new Text(allTranslations.text('Send times'),style: TextStyle(color: Colors.grey)),
                                              content: new Text(allTranslations.text('By sending timesheet you confirm the assignments on it. Proceed?'),style: TextStyle(color: Colors.grey)),
                                              actions: <Widget>[
                                                new FlatButton(
                                                ...
                                                new FlatButton(
                                                    onPressed: () async {
                                                      ...
                                                      String url ='https://mijnzpc.com/api/v1/sendtimes?token='+token+'&emploeeconfirm='+widget.data.id.toString();
                            ...
                            child: Padding(
                              ...
                              child:Center(
                                child: Text(allTranslations.text('Send Times') ,textAlign: TextAlign.center,style: TextStyle(fontSize: 18)),
                              ),
                            )
                        )
                    ):new Container(),
