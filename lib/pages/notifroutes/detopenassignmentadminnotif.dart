...
import 'package:mijnzpc/all_translations.dart';import 'package:mijnzpc/pages/dashboard/openassignments/openassignment.dart';
class Detopenassignmentadminnotif extends StatefulWidget {

  Detopenassignmentadminnotif(
  ...
  @override
  State<StatefulWidget> createState() => new DetopenassignmentadminnotifState();

}

class DetopenassignmentadminnotifState extends State<Detopenassignmentadminnotif> with AutomaticKeepAliveClientMixin<Detopenassignmentadminnotif> {
                    ...
                    child:  DecoratedBox(
                        ...
                        child:ElevatedButton(
                            ...
                            child: Padding(
                              ...
                              child:Center(
                                child: Text(allTranslations.text('suggestions') ,textAlign: TextAlign.center,style: TextStyle(fontSize: 18)),
                              ),
                            )
                        )
                    ),
