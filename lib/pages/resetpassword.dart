...
class Resetpassword extends StatefulWidget {
  ...
  Resetpassword(
      {@required this.backgroundcolor,this.email,this.code,
                            ...
                            children: <Widget>[
                              Padding(
                                ...
                                child: Align(
                                  ...
                                  child:
                                  Text(allTranslations.text("Change Password"),style: TextStyle(
                              ...
                              Padding(
                                ...
                                child: Align(
                                  alignment: Alignment.centerLeft,
                                  child:
                                  Text(allTranslations.text("Please choose your new password"),style: TextStyle(
                                      // fontWeight: FontWeight.w700,
                                      letterSpacing: 0.5,
                                      color: Colors.white,
                                      fontSize: 14
                                        ...
                                        children: <Widget>[
                                          ...
                                          Padding(
                                            ...
                                            child: TextFormField(
                                              ...
                                              decoration: InputDecoration(
                                                hintText: allTranslations.text("Enter Your password"),
                                          ...
                                          Padding(
                                            ...
                                            child: TextFormField(
                                              ...
                                              decoration: InputDecoration(
                                                hintText: allTranslations.text("Re-enter Your password"),
                                                hintStyle: TextStyle(color: Colors.grey),
                                                prefixIcon: Icon(Icons.password,color: Colors.grey,),
                                                border: myinputborder(),
                                                enabledBorder: myinputborder(),
                                              ...
                                              child:  DecoratedBox(
                                                  ...
                                                  child:ElevatedButton(
                                                      ...
                                                      onPressed: ()async {
                                                              ...
                                                              builder: (context) {
                                                                return new Directionality(
                                                                    ...
                                                                    child: new AlertDialog(
                                                                      ...
                                                                      content: new Text(allTranslations.text("please fill your new password")),
                                                                      actions: <Widget>[
                                                          ...
                                                          return showDialog(
                                                              ...
                                                              builder: (context) {
                                                                return new Directionality(
                                                                    ...
                                                                    child: new AlertDialog(
                                                                      title: new Text(allTranslations.text('Alert')),
                                                                      content: new Text(allTranslations.text("your passwords are not match")),
                                                                      actions: <Widget>[
                                                        ...
                                                        final response = await  http.get(Uri.parse('https://mijnzpc.com/api/v1/resetpassword?email=' + widget.email+'&code='+widget.code+'&password='+_emailValue));
                                                          ...
                                                          return showDialog(
                                                              ...
                                                              builder: (context) {
                                                                return new Directionality(
                                                                    ...
                                                                    child: new AlertDialog(
                                                                      title: new Text(allTranslations.text('Alert')),
                                                                      content: new Text(allTranslations.text("password has been changed")),
                                                                      actions: <Widget>[
                                                          ...
                                                          return showDialog(
                                                              ...
                                                              builder: (context) {
                                                                return new Directionality(
                                                                    ...
                                                                    child: new AlertDialog(
                                                                      title: new Text(allTranslations.text('Alert')),
                                                                      content: new Text(allTranslations.text("something went Wrong")),
                                                                      actions: <Widget>[
