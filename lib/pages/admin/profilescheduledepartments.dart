...
class Profilescheduledepartment extends StatefulWidget {

  Profilescheduledepartment(
  ...
  @override
  State<StatefulWidget> createState() => new ProfilescheduledepartmentState();

}

class ProfilescheduledepartmentState extends State<Profilescheduledepartment> with AutomaticKeepAliveClientMixin<Profilescheduledepartment> {
