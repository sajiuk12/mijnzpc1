...
class Profilefinancialpartment extends StatefulWidget {

  Profilefinancialpartment(
  ...
  @override
  State<StatefulWidget> createState() => new ProfilefinancialpartmentState();

}

class ProfilefinancialpartmentState extends State<Profilefinancialpartment> with AutomaticKeepAliveClientMixin<Profilefinancialpartment> {
