...
import 'package:mijnzpc/pages/admin/managedocumentoptional.dart';
import 'package:mijnzpc/pages/admin/uploaddocumentadmin.dart';
...
import 'dart:convert';
class Managedocumentsadmin extends StatefulWidget {

  Managedocumentsadmin(
  ...
  @override
  _ManagedocumentState createState() => _ManagedocumentState();
}

class _ManagedocumentState extends State<Managedocumentsadmin> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
        onWillPop: () async {
          Navigator.push(context, new MaterialPageRoute(builder: (context) => new Profilefreelancer(data: widget.data,
                    ...
                    child:  SizedBox(
                        ...
                        child:  DecoratedBox(
                            ...
                            child:ElevatedButton(
                                ...
                                onPressed: (){
                                  Navigator.push(context, new MaterialPageRoute(builder: (context) => new Uploadadmin(backgroundcolor: widget.backgroundcolor,
                                  data:widget.data,
                                    color: widget.color,
                                    gradiantcolor:widget.gradiantcolor,
                                    cardcolor:widget.cardcolor,
                    ...
                    Container(
                      ...
                      Padding(
                        ...
                        child: Align(
                            ...
                            child: InkWell(
                              onTap: () {
                                Navigator.push(context, new MaterialPageRoute(builder: (context) => new Managedocumentsoptionaladmin(data:widget.data,backgroundcolor: widget.backgroundcolor,
                                  color: widget.color,
                                  gradiantcolor:widget.gradiantcolor,
                                  cardcolor:widget.cardcolor,
                                  shadowcolor:widget.shadowcolor,
                                                    ...
                                                    return new Container(
                                                        ...
                                                        child: new Directionality(
                                                            ...
                                                            child: new AlertDialog(
                                                              ...
                                                              content: new Text(allTranslations.text('You are about to delete this document. Proceed?'),style: TextStyle(color: Colors.grey)),
                                                              actions: <Widget>[
                                                                new FlatButton(
                                                                ...
                                                                new FlatButton(
                                                                    onPressed: () async {
                                                                      ...
                                                                      String url ='https://mijnzpc.com/api/v1/delete/documents?token='+token+'&id='+_recordsdata[index].id.toString();
                                                                      print(url);
...
//if user pull to refresh page
  ...
  _getrecords({ int page : 1 , bool refresh : false}) async
  {
    ...
    var response = await classgetservicesassignment.actiongetimagesadmin(widget.data.id,'mandetory');
    setState(() {
...
//  getting data from model
  ...
  _getrecords1({ int page : 1 , bool refresh : false}) async
  {
    ...
    var response = await classgetservicesassignment.actiongetimages('mandetory');
    setState(() {
