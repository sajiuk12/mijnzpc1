...
class Profileclient extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => new ProfileclientState();

}

class ProfileclientState extends State<Profileclient> with AutomaticKeepAliveClientMixin<Profileclient> {
