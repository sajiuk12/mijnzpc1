...
import 'package:mijnzpc/all_translations.dart';import 'package:http/http.dart' as http;
import 'dart:convert';
class Managedocumentsoptionaladmin extends StatefulWidget {

  Managedocumentsoptionaladmin(
...
class _ManagedocumentState extends State<Managedocumentsoptionaladmin> {
...
//if user pull to refresh page
  ...
  _getrecords({ int page : 1 , bool refresh : false}) async
  {
    ...
    var response = await classgetservicesassignment.actiongetimagesadmin(widget.data.id,'optional');
    setState(() {
