...
import 'package:mijnzpc/all_translations.dart';
class Scheduledepartments extends StatefulWidget {
  ...
  @override
  ScheduledepartmentsState createState() => ScheduledepartmentsState();
}

class ScheduledepartmentsState extends State<Scheduledepartments> {
      ...
      Scaffold(
        appBar: new AppBar(
          ...
          title:Padding(
            ...
            child: new Text(allTranslations.text('Schedules'),style: TextStyle(color: Colors.grey),),),
                          ...
                          child: Container(
                            ...
                            new Column(
                              children: <Widget>[
                                new GestureDetector(
                                  onTap: () {
                                    Navigator.push(context, new MaterialPageRoute(builder: (context) => new Profilescheduledepartment(data: _recordsdata[index],backgroundcolor: widget.backgroundcolor,
                                      color: widget.color,
                                      gradiantcolor:widget.gradiantcolor,
                                      cardcolor:widget.cardcolor,
                                      shadowcolor:widget.shadowcolor,
...
//if user pull to refresh page
  ...
  _getrecords({ int page : 1 , bool refresh : false}) async
  {
    ...
    var response = await classgadminservices.actiongetscheduls(page);
    setState(() {
