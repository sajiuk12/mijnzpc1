...
class Filterinvoicetype extends StatefulWidget {
  ...
  @override
  _FilterinvoicetypeState createState() => _FilterinvoicetypeState();
}

class _FilterinvoicetypeState extends State<Filterinvoicetype> {
    ...
    return
      Scaffold(
        appBar: AppBar(
            ...
            title: Text(
              allTranslations.text("Select type"),
                            ...
                            children: <Widget>[
                              ...
                              new GestureDetector(
                                onTap: () {
                                  ...
                                  setState((){
                                    showname=getsuggestionname(_recordsdata[index].title.toString());
                                  });
                                          ...
                                          children: <Widget>[
                                            ...
                                            Container(
                                              ...
                                              child: Column(
                                                ...
                                                children: <Widget>[
                                                  Text(
                                                    allTranslations.text(getsuggestionname(_recordsdata[index].title)) ,
                                                    style: TextStyle(
                                                      color: Colors.grey,
...
//  getting data from model
  ...
  getsuggestionname(String name)
  {
    ...
    if(name=="2023")
    {
      return "zpcpaytoemploee";
    }
    else
    if(name=="2024")
    {
      return "clientpaytozpc";
    }
    else
    if(name=="2025")
    {
      return "clientpaytoemploee";
    }
    else
    {
      return "All";
