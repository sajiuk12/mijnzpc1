...
class Filtersuggestionadmin extends StatefulWidget {
  String idfromfirstpage;


  Filtersuggestionadmin(
  ...
  @override
  _FiltersuggestionadminState createState() => _FiltersuggestionadminState();
}

class _FiltersuggestionadminState extends State<Filtersuggestionadmin> {
    ...
    return
      Scaffold(
        appBar: AppBar(
            ...
            title: Text(
              allTranslations.text("Suggestions"),
                            ...
                            children: <Widget>[
                              ...
                              new GestureDetector(
                                onTap: () {
                                  ...
                                  setState((){
                                    showname=allTranslations.text(getsuggestionname(_recordsdata[index].title.toString()));
                                  });
