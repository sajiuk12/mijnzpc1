...
class _MyHomePageState extends State<Filtersort> {
    ...
    return
      Scaffold(
        appBar: AppBar(
            ...
            title: Text(
            allTranslations.text("Select Sort"),
            ...
            children: [
              ...
              onChanged: (String value) async {
                ...
                decoration: InputDecoration(
                  labelText: allTranslations.text('Sort'),
...
//if user pull to refresh page
  ...
  _getrecords({ int page : 1 ,int daste : 9, bool refresh : false}) async
  {
    ...
    var response = await classfilterservices.actiongetsortfilters(showname);
    setState(() {
      _recordsdata.clear();
