...
class Filterstartdate extends StatefulWidget {
...
class _MyHomePageState extends State<Filterstartdate> {
    ...
    return
      Scaffold(
        appBar: AppBar(
            ...
            title: Text(
            allTranslations.text("Select Dates"),
                            ...
                            children: <Widget>[
                              ...
                              new GestureDetector(
                                onTap: () {
                                  ...
                                  setState((){
                                   id=_recordsdata[index].start_date.toString();
                                  });
...
print(id);
  ...
  //  all needs variable
  List<Mfilterstartdate> _recordsdata = [];
  int _currentPage = 1;
...
//if user pull to refresh page
  ...
  _getrecords({ int page : 1 ,int daste : 9, bool refresh : false}) async
  {
    ...
    var response = await classfilterservices.actiongetstart_datefilters(showname);
    print('jjjjjjjjjjj');
    setState(() {
      _recordsdata.clear();
