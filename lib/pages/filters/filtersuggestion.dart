...
class Filtersuggestion extends StatefulWidget {
  ...
  @override
  _FiltersuggestionState createState() => _FiltersuggestionState();
}

class _FiltersuggestionState extends State<Filtersuggestion> {
