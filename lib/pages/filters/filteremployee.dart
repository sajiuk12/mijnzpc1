...
class Filteremployee extends StatefulWidget {
...
class _MyHomePageState extends State<Filteremployee> {
                            ...
                            children: <Widget>[
                              ...
                              new GestureDetector(
                                onTap: () {
                                  ...
                                  setState((){
                                    id=_recordsdata[index].user_id.toString();
                                  });
...
//print(client);
  ...
  //  all needs variable
  List<Mfilteremployee> _recordsdata = [];
  int _currentPage = 1;
...
//if user pull to refresh page
  ...
  _getrecords({ int page : 1 ,int daste : 9, bool refresh : false}) async
  {
    ...
    var response = await classfilterservices.actiongetemployeefilters(first_name,last_name);
    setState(() {
      _recordsdata.clear();
      ...
      if(responseBody['profile'].toList().length > 0)
      {
        setState(() {
          ...
          last_name = responseBody['profile'][0]['last_name'];
           textFieldController.text = first_name;
           textFieldController2.text = last_name;
        });
      }
    }
    _recordsdata.clear();
