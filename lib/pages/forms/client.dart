...
import 'package:mijnzpc/pages/forms/addressforclient.dart';
...
class Client extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => new ClientState();
}
enum Fruit { MALE, FEMALE }
class ClientState extends State<Client> with SingleTickerProviderStateMixin {
                            ...
                            children: <Widget>[
                              ...
                              TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: "Address extra (optional)",
                                  hintStyle: TextStyle(color: Colors.grey),
                                  prefixIcon: Icon(Icons.password,color: Colors.grey,),
                                  border: myinputborder(),
                                  enabledBorder: myinputborder(),
  ...
  void _awaitReturnValueFromSecondScreen(String text) async {
    final result = await  Navigator.of(context).push(
        MaterialPageRoute(builder:(context)=>Addressforclient(text)));
    setState(() {
      if(result!=null)
      {
        addressid = result;
  ...
  getplaceid(String placeid) async{
    String url ='https://mijnzpc.com/api/v1/getaddress?ttt='+placeid;
