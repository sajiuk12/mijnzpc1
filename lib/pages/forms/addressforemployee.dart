                              ...
                              new GestureDetector(
                                onTap: () {
                                  ...
                                  setState((){
                                    ...
                                    housenumber=_recordsdata[index].housenumber.toString();
                                  });
                                            ...
                                            Container(
                                              ...
                                              child: Column(
                                                ...
                                                children: <Widget>[
                                                  ...
                                                  Text(
                                                    _recordsdata[index].address_line1.toString(),
                                                    style: TextStyle(
                                                      color: Colors.black,
                                                  ...
                                                  Text(
                                                    _recordsdata[index].postcode.toString(),
                                                    style: TextStyle(
                                                      color: Colors.black,
                                                      fontWeight: FontWeight.w400,
                                                      fontSize: 14.0,
                                                  ...
                                                  Text(
                                                    _recordsdata[index].country.toString(),
                                                    style: TextStyle(
                                                      color: Colors.black,
                                                      fontWeight: FontWeight.w400,
                                                      fontSize: 14.0,
                                                  ...
                                                  Text(
                                                    _recordsdata[index].city.toString(),
                                                    style: TextStyle(
                                                      color: Colors.black,
                                                      fontWeight: FontWeight.w400,
                                                      fontSize: 14.0,
...
//  getting data from model
  ...
  void _sendDataBack(BuildContext context) {
    ...
    Navigator.of(context).pop({"addressid":addressid,"housenumber":housenumber});
