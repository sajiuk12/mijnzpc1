...
class Addressforclient extends StatefulWidget {
  String addressfromfirstpage;
  Addressforclient(this.addressfromfirstpage);
  @override
  AddressforclientState createState() => AddressforclientState();
}

class AddressforclientState extends State<Addressforclient> {
