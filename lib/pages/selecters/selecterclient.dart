...
class Selecterclient extends StatefulWidget {
  String clientidfromfirstpage;
  String jobtitlefromfirstpage;
  ...
  Selecterclient(
      {@required this.clientidfromfirstpage,this.backgroundcolor,
        ...
        this.appbarcolor,this.titlecolor,this.textcolor,this.bottombarcolor,this.jobtitlefromfirstpage});
  ...
  @override
  _SelecterclientState createState() => _SelecterclientState();
}

class _SelecterclientState extends State<Selecterclient> {
...
//if user pull to refresh page
  ...
  _getrecords({ int page : 1 ,int daste : 9, bool refresh : false}) async
  {
    ...
    var response = await classfilterservices.actiongetclientselecter(company_name,widget.jobtitlefromfirstpage);
    setState(() {
      _recordsdata.clear();
