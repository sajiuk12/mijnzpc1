...
import 'package:mijnzpc/pages/firstactivepages/managedocumentoptionalfirstactive.dart';
import 'package:mijnzpc/pages/firstactivepages/uploaddocument.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:mijnzpc/pages/dashboard/assignments/detassignment.dart';
import 'package:mijnzpc/pages/dashboard/invoices/managedocumentoptional.dart';
...
class Managedocumentfirstactive extends StatefulWidget {



  @override
  _ManagedocumentfirstactiveState createState() => _ManagedocumentfirstactiveState();
}

class _ManagedocumentfirstactiveState extends State<Managedocumentfirstactive> {
                    ...
                    child:  SizedBox(
                        ...
                        child:  DecoratedBox(
                            ...
                            child:ElevatedButton(
                                ...
                                onPressed: (){
                                  Navigator.push(context, new MaterialPageRoute(builder: (context) => new Uploadfirstactive()));
                                },
                                child: Padding(
                    ...
                    Container(
                      ...
                      Padding(
                        ...
                        child: Align(
                            ...
                            child: InkWell(
                              onTap: () {
                                Navigator.push(context, new MaterialPageRoute(builder: (context) => new Managedocumentoptionalfirstactive()));
                              },
