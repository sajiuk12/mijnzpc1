...
import 'package:mijnzpc/pages/sendinvoice.dart';
...
/////////old late AndroidNotificationChannel channel;
...
Future<void> main() async {
  ...
  await Firebase.initializeApp(name: 'mijnzpc',options: DefaultFirebaseOptions.currentPlatform);
...
getTokenz() async {
  ...
  await prefs.setString('user.fcmtoken', token);
...
class MessagingExampleApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
      ...
      routes: {
        "/" : (context) => new Directionality(textDirection: TextDirection.ltr, child: SplashScreen()),
        "/login" : (context) => new Directionality(textDirection: TextDirection.ltr, child: new LoginScreen()),
        "/home" : (context) => new Directionality(textDirection: TextDirection.ltr, child: new MyHomePages()),
        "/setting" : (context) => new SettingScreen(),
        "/settings/select_language" : (context) => prepareScreen(new SelectLanguageScreen()),
        "/notactive" : (context) => new Notactive(),
        "/firstactive" : (context) => new Managedocumentfirstactive(),
        "/confirmemail" : (context) => new Confirmemail(),
