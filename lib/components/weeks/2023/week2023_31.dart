...
class week2023_31 extends StatefulWidget {
  final String hint;

  week2023_31({this.hint, this.data});


  List<Massignment> data = [];

  @override
  State<StatefulWidget> createState() => new week2023_31State();

}
class week2023_31State extends State<week2023_31> {
