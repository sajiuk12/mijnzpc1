...
class week2023_33 extends StatefulWidget {
  final String hint;

  week2023_33({this.hint, this.data});


  List<Massignment> data = [];

  @override
  State<StatefulWidget> createState() => new week2023_33State();

}
class week2023_33State extends State<week2023_33> {
