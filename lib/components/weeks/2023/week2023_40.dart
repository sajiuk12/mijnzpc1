...
class week2023_40 extends StatefulWidget {
  final String hint;

  week2023_40({this.hint, this.data});


  List<Massignment> data = [];

  @override
  State<StatefulWidget> createState() => new week2023_40State();

}
class week2023_40State extends State<week2023_40> {
