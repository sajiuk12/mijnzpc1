...
class week2023_34 extends StatefulWidget {
  final String hint;

  week2023_34({this.hint, this.data});


  List<Massignment> data = [];

  @override
  State<StatefulWidget> createState() => new week2023_34State();

}
class week2023_34State extends State<week2023_34> {
