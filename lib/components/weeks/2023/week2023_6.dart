...
class week2023_6 extends StatefulWidget {
  final String hint;

  week2023_6({this.hint, this.data});


  List<Massignment> data = [];

  @override
  State<StatefulWidget> createState() => new week2023_6State();

}
class week2023_6State extends State<week2023_6> {

  String selectedmonth="01";


  var day1 = [
    'Monday'  ,'06 February 2023','2023-02-06','06'
  ];
  var day2 = [
    'Theusday'  ,'07 February 2023','2023-02-07','07'
  ];
  var day3 = [
    'Wednesday'  ,'08 February 2023','2023-02-08','08'
  ];
  var day4 = [
    'Thursday'  ,'09 February 2023','2023-02-09','09'
  ];
  var day5 = [
    'Friday'  ,'10 February 2023','2023-02-10','10'
  ];
  var day6 = [
    'Saturday'  ,'11 February 2023','2023-02-11','11'
  ];
  var day7 = [
    'Sunday'  ,'12 February 2023','2023-02-12','12'
  ];
