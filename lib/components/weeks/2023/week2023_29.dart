...
class week2023_29 extends StatefulWidget {
  final String hint;

  week2023_29({this.hint, this.data});


  List<Massignment> data = [];

  @override
  State<StatefulWidget> createState() => new week2023_29State();

}
class week2023_29State extends State<week2023_29> {
