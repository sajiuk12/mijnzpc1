...
class week2023_32 extends StatefulWidget {
  final String hint;

  week2023_32({this.hint, this.data});


  List<Massignment> data = [];

  @override
  State<StatefulWidget> createState() => new week2023_32State();

}
class week2023_32State extends State<week2023_32> {
