...
class week2023_47 extends StatefulWidget {
  final String hint;

  week2023_47({this.hint, this.data});


  List<Massignment> data = [];

  @override
  State<StatefulWidget> createState() => new week2023_47State();

}
class week2023_47State extends State<week2023_47> {
