...
class week2023_42 extends StatefulWidget {
  final String hint;

  week2023_42({this.hint, this.data});


  List<Massignment> data = [];

  @override
  State<StatefulWidget> createState() => new week2023_42State();

}
class week2023_42State extends State<week2023_42> {
