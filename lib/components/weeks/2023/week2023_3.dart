...
class week2023_3 extends StatefulWidget {
  final String hint;

  week2023_3({this.hint, this.data});


  List<Massignment> data = [];

  @override
  State<StatefulWidget> createState() => new week2023_3State();

}
class week2023_3State extends State<week2023_3> {

  String selectedmonth="01";


  var day1 = [
    'Monday'  ,'16 January 2023','2023-01-16','16'
  ];
  var day2 = [
    'Theusday'  ,'17 January 2023','2023-01-17','17'
  ];
  var day3 = [
    'Wednesday'  ,'18 January 2023','2023-01-18','18'
  ];
  var day4 = [
    'Thursday'  ,'19 January 2023','2023-01-19','19'
  ];
  var day5 = [
    'Friday'  ,'20 January 2023','2023-01-20','20'
  ];
  var day6 = [
    'Saturday'  ,'21 January 2023','2023-01-21','21'
  ];
  var day7 = [
    'Sunday'  ,'22 January 2023','2023-01-22','22'
  ];
