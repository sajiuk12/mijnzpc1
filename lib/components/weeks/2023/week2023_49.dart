...
class week2023_49 extends StatefulWidget {
  final String hint;

  week2023_49({this.hint, this.data});


  List<Massignment> data = [];

  @override
  State<StatefulWidget> createState() => new week2023_49State();

}
class week2023_49State extends State<week2023_49> {
