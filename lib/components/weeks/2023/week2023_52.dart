...
class week2023_52 extends StatefulWidget {
  final String hint;

  week2023_52({this.hint, this.data});


  List<Massignment> data = [];

  @override
  State<StatefulWidget> createState() => new week2023_52State();

}
class week2023_52State extends State<week2023_52> {
