...
class week2023_45 extends StatefulWidget {
  final String hint;

  week2023_45({this.hint, this.data});


  List<Massignment> data = [];

  @override
  State<StatefulWidget> createState() => new week2023_45State();

}
class week2023_45State extends State<week2023_45> {
