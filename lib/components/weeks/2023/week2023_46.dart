...
class week2023_46 extends StatefulWidget {
  final String hint;

  week2023_46({this.hint, this.data});


  List<Massignment> data = [];

  @override
  State<StatefulWidget> createState() => new week2023_46State();

}
class week2023_46State extends State<week2023_46> {
