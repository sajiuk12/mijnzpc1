...
class week2023_48 extends StatefulWidget {
  final String hint;

  week2023_48({this.hint, this.data});


  List<Massignment> data = [];

  @override
  State<StatefulWidget> createState() => new week2023_48State();

}
class week2023_48State extends State<week2023_48> {
