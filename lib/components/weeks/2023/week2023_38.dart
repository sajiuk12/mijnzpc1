...
class week2023_38 extends StatefulWidget {
  final String hint;

  week2023_38({this.hint, this.data});


  List<Massignment> data = [];

  @override
  State<StatefulWidget> createState() => new week2023_38State();

}
class week2023_38State extends State<week2023_38> {
