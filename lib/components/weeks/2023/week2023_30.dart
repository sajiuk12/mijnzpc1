...
class week2023_30 extends StatefulWidget {
  final String hint;

  week2023_30({this.hint, this.data});


  List<Massignment> data = [];

  @override
  State<StatefulWidget> createState() => new week2023_30State();

}
class week2023_30State extends State<week2023_30> {
