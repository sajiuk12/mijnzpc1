...
class week2023_44 extends StatefulWidget {
  final String hint;

  week2023_44({this.hint, this.data});


  List<Massignment> data = [];

  @override
  State<StatefulWidget> createState() => new week2023_44State();

}
class week2023_44State extends State<week2023_44> {
