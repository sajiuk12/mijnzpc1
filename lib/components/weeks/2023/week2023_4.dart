...
class week2023_4 extends StatefulWidget {
  final String hint;

  week2023_4({this.hint, this.data});


  List<Massignment> data = [];

  @override
  State<StatefulWidget> createState() => new week2023_4State();

}
class week2023_4State extends State<week2023_4> {

  String selectedmonth="01";


  var day1 = [
    'Monday'  ,'23 January 2023','2023-01-23','23'
  ];
  var day2 = [
    'Theusday'  ,'24 January 2023','2023-01-24','24'
  ];
  var day3 = [
    'Wednesday'  ,'25 January 2023','2023-01-25','25'
  ];
  var day4 = [
    'Thursday'  ,'26 January 2023','2023-01-26','26'
  ];
  var day5 = [
    'Friday'  ,'27 January 2023','2023-01-27','27'
  ];
  var day6 = [
    'Saturday'  ,'28 January 2023','2023-01-28','28'
  ];
  var day7 = [
    'Sunday'  ,'29 January 2023','2023-01-29','29'
  ];
