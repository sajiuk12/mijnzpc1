...
class week2023_41 extends StatefulWidget {
  final String hint;

  week2023_41({this.hint, this.data});


  List<Massignment> data = [];

  @override
  State<StatefulWidget> createState() => new week2023_41State();

}
class week2023_41State extends State<week2023_41> {
