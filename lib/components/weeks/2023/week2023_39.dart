...
class week2023_39 extends StatefulWidget {
  final String hint;

  week2023_39({this.hint, this.data});


  List<Massignment> data = [];

  @override
  State<StatefulWidget> createState() => new week2023_39State();

}
class week2023_39State extends State<week2023_39> {
