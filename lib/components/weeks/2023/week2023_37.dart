...
class week2023_37 extends StatefulWidget {
  final String hint;

  week2023_37({this.hint, this.data});


  List<Massignment> data = [];

  @override
  State<StatefulWidget> createState() => new week2023_37State();

}
class week2023_37State extends State<week2023_37> {
