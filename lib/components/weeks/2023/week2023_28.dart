...
class week2023_28 extends StatefulWidget {
  final String hint;

  week2023_28({this.hint, this.data});


  List<Massignment> data = [];

  @override
  State<StatefulWidget> createState() => new week2023_28State();

}
class week2023_28State extends State<week2023_28> {
