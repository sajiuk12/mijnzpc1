...
class week2023_35 extends StatefulWidget {
  final String hint;

  week2023_35({this.hint, this.data});


  List<Massignment> data = [];

  @override
  State<StatefulWidget> createState() => new week2023_35State();

}
class week2023_35State extends State<week2023_35> {
