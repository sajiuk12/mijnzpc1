...
class week2023_27 extends StatefulWidget {
  final String hint;

  week2023_27({this.hint, this.data});


  List<Massignment> data = [];

  @override
  State<StatefulWidget> createState() => new week2023_27State();

}
class week2023_27State extends State<week2023_27> {
