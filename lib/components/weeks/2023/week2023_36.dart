...
class week2023_36 extends StatefulWidget {
  final String hint;

  week2023_36({this.hint, this.data});


  List<Massignment> data = [];

  @override
  State<StatefulWidget> createState() => new week2023_36State();

}
class week2023_36State extends State<week2023_36> {
