...
class week2023_51 extends StatefulWidget {
  final String hint;

  week2023_51({this.hint, this.data});


  List<Massignment> data = [];

  @override
  State<StatefulWidget> createState() => new week2023_51State();

}
class week2023_51State extends State<week2023_51> {
