...
class week2023_43 extends StatefulWidget {
  final String hint;

  week2023_43({this.hint, this.data});


  List<Massignment> data = [];

  @override
  State<StatefulWidget> createState() => new week2023_43State();

}
class week2023_43State extends State<week2023_43> {
